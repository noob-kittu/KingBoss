...
from DaisyX import OWNER_USERNAME, SUPPORT_CHAT
...
async def awake(event):
    ...
    BUTTON = [
        [
            ...
            Button.url("DEVLOPER", f"https://t.me/{OWNER_USERNAME}"),
        ]
    ]
...
async def callback_query_handler(event):
    ...
    kittu += [
        [
            Button.url("SUPPORT CHANNEL", "https://t.me/korateam"),
            Button.url("SUPPORT GROUP", "https://t.me/SUPPORT_CHAT"),
        ]
    ]
